  ...
  return (
    <>
      <div className="flex flex-row p-4 cursor-pointer border-b border-gray-500">
          <img src={picture} className="rounded-lg h-12" />
          <div className="grid grid-rows-2 text-start items-center">
              ...
              <h1 className="text-xl rounded-lg mx-1 px-1 truncate overflow-hidden hover:text-clip hover:bg-neutral-800 transition duration-100">{display_name}</h1>
