...
const MessagesNavList = ({ message_list, peer_profile, profiles, setPeer }) => {
  ...
  return (
    <>
      <div className="p-3">
          <input type="text" placeholder="Search..." className="rounded-sm w-full bg-neutral-800 px-2 placeholder-neutral-500 focus:placeholder-opacity-0"/>
      </div>
