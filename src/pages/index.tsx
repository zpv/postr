...
function App({peer, setPeer, user, setUser}) {
  ...
  const privkey="bb13681e0cd2f86d6a8d124fe051abf8a8a250a6d7357cb6b6e67a8640203ece";
  ...
  return (
    ...
    <input className="rounded-lg px-2 bg-slate-600" id="pubkeyinput" type="text" value={user} onChange={(e) => setUser(e.target.value)} placeholder="Enter private key"/>
    ...
    <Link href={`/messages?privkey=${privkey}`} >
      <h2 className="rounded-lg px-2 bg-neutral-800 hover:bg-slate-700 cursor-pointer" onClick={(e) => setUser(privkey)}>Launch with default private key</h2>
    </Link>
    </div>
